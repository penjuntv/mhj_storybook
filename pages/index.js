...
const I18N = {
  ko: {
    ...
    goToColoringButton: "이 동화로 색칠 놀이 하기",
  },
  en: {
    ...
    goToColoringButton: "Turn this story into coloring pages",
  },
  zh: {
        ...
        <section className="step-section">
          ...
          <div className="step2-story">
            ...
            <div className="story-result">
              ...
              {/* 스토리가 있을 때만 색칠 페이지로 이동 버튼 노출 */}
              {!storyLoading && !storyError && story && (
                <div className="request-row" style={{ marginTop: 16 }}>
                  <button type="button" onClick={handleGoToColoring}>
                    {t.goToColoringButton}
                  </button>
                </div>
              )}
            </div>
