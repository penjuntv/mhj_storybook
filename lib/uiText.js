...
const TEXT = {
  ...
  en: {
    ...
    ideasTooFewWords: "Please choose at least two words to get better ideas.",
  },
  ...
  zh: {
    ...
    themeTitle: "选择故事主题",
    themeSubtitle: "选一个和单词相配的主题，故事的气氛会随之变化。",
...
/**
 * 언어 코드에 맞는 UI 텍스트를 돌려준다.
 * pages/index.js 에서 사용하는 step2NameLabel 등의 키도
 * 여기에서 항상 채워서 반환한다.
 */
export function getUIText(language) {
  ...
  // 항상 객체를 반환하고, STEP2용 alias 필드를 추가
  return {
    ...base,

    // STEP 2용 alias (index.js에서 사용하는 이름)
    step2NameLabel: base.kidNameLabel,
    step2NamePlaceholder: base.kidNameLabel, // 별도 placeholder가 없으니 라벨 재사용
    step2PovLabel: base.povLabel,
    step2ThemeLabel: base.themeTitle,
    step2LengthLabel: base.lengthTitle,
  };
}
